document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadSettings() {
        ...
        chrome.storage.local.get(keys).then((result) => {
            ...
            randomizeToggle.checked = false; // Grok: desativado por padrão
            randomAllCheckbox.checked = true;
    ...
    function saveSettings() {
        ...
        chrome.storage.local.set({
            ...
            randomizeToggle: false, // Forçado para false no Grok
            randomizeAll: true,
    ...
    function updateRandomizeUI() {
        randomizeSection.style.display = 'none'; // Oculto no Grok
    }
